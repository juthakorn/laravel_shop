...
<div class="container-fluid limited">
    ...
    <?php } ?>
    <div class="row">
        <div class="<?= empty($data) ? "col-lg-12" : "col-lg-8" ?> col-sm-12">
                ...
                <table class="table table-bordered table-cart" id="table-cart">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th style="width: 109px;">{{ trans('cart.Price')." (".trans('cart.baht').")" }}</th>
                            <th style="width: 100px;">{{ trans('cart.Quantity') }}</th>
                            <th style="width: 133px;">{{ trans('cart.SubTotal')." (".trans('cart.baht').")" }}</th>
                   ...
                   foreach ($data as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url(UrlProduct($product->id, $product->slug_url)) }}" class="d-block" >{{ $product->p_name }}</a>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="btn btn-danger btn-circle btn-remove-option" data-toggle="tooltip" data-placement="top" data-original-title="Remove"><i class="fa fa-times"></i></a>
                            </td>
            ...
            <div class="form-group col-sm-6" style=" padding-right: 0; padding-left: 0">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                      <button class="btn btn-theme" type="button" id="check_code_discounts" style="border-top-left-radius: 0;border-bottom-left-radius: 0;">{{ trans('cart.code_apply')}}</button>
                  </span>
                </div>
            </div>
...
<!--                <nav>
                ...
                <div class="row">
                    <div class="col-6 text-left no-padding-right">
                        <a href="{{ url(UrlproductAll()) }}" class="btn btn-theme"><span aria-hidden="true"></span><i class="fa fa-fw fa-chevron-left"></i> {{ trans('cart.Continue Shopping') }}</a>
                    </div> 
                    <div class="col-6 text-right no-padding-left">
                        <a href="javascript:void(0)" onclick="Cart.chkdelivery()" class="btn btn-theme">{{ trans('cart.Checkout') }} <i class="fa fa-fw fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
<script src="{{ URL::asset('shop-v2/js/cart.js') }}"></script>
@endsection
