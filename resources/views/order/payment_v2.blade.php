        ...
        <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-12">  
                    ...
                    <div class="form-payment col-md-12">
                        <div class="form-group row">
                            <label  class="col-md-3 col-form-label required_field">{{ trans('common.Transfer account') }}</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label required_field">{{ trans('common.Transfer Date') }}</label>
                            <div class="col-md-7"> 
...
<!--                                <div class="input-group-addon">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label required_field">{{ trans('common.Time_estimated') }}</label>
                            <div class="col-md-7"> 
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label required_field">{{ trans('common.Amount') }} (฿)</label>
                            <div class="col-md-7">      
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label ">{{ trans('common.Transfer proof') }}</label>
                            <div class="col-md-7">      
                        ...
                        <div class="form-group row" id="table-order">                           
                            <label class="col-md-3 col-form-label required_field">{{ trans('cart.paid_order_item') }}</label>
                            <div class="col-md-9"> 
                                <div class="table-responsive" >
                                    <table class="table table-bordered table-gray">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="center" style="vertical-align: middle"><a href="{{ url(customer_order_detail($value->order_id)) }}"><span class="badge2">{{ $value->order_id }}</span></a></td>
                                                <td>
                                                <?php
                         ...
                         <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ trans('common.More detail') }}</label>
                            <div class="col-md-7">     
...
@section('script')
<script src="{{ URL::asset('shop-v2/js/bootstrap-filestyle.min.js') }}"></script>
