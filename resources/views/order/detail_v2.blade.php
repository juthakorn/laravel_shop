...
<div class="container-fluid limited mb-5">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="title"><span>{{ trans('common.my_order')." #".$order->order_id }}</span></div>    
            ...
            <div class="row">                
                ...
                <div class="col-lg-12">
                    <div class="well" >                         
                        <div class="pull-left" style="font-size: 1.2rem;color: #d94848;"><strong>{{ trans('cart.text_net_amount')." ".number_format($order->final_sum,2)." ".trans('cart.baht').(App::getLocale() == 'th' ? "" : ".") }}</strong></div>                       
                        <a href="{{ url(UrlPayment()) }}" class="btn btn-primary pull-right"><i class="fa fa-credit-card"></i> {{ trans('cart.Payment') }}</a>                            
                         
                        <div class="clearfix"></div>
                        
                        <div class="table-responsive" style=" margin-top: 5px">
                            <table class="table table-bordered table-cart table-banks" >
                                <thead>
                                ...
                                <tbody>
                                    <?php foreach ($banks as $key => $bank) { ?>
                                        <tr>
                                            <td class="img-cart" style="width: 45px;padding: 5px;">
                                                <img class="media-object img-thumbnail" src="<?= url("image/" . imgbank($bank->bank_name)) ?>" alt="<?= $bank->bank_name ?>" style="border-radius: 32px;width: 35px;" >                               
                                            </td>
                        ...
                        <table class="table table-cart table-bordered table-gray">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center vertical-middle" >
                                    ...
                                    <td>
                                        <a href="{{ url(UrlPaymentinfo($value->id))}}" target="_blank" class="btn btn-default btn-circle" title="{{ trans('common.view_detail') }}"><i class="material-icons">search</i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
