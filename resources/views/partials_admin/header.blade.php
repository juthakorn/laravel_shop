<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo" target="_blank">
        ...
        <span class="logo-lg"><b>TM</b>SHOP</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ !empty(Auth::user()->user_image) ? url(Auth::user()->user_image) : url('/shop/images/demo/user.png') }}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ url(customer()) }}" class="btn btn-default btn-flat">Profile</a>
                            </div>
