...
<div class="container-fluid limited">
    ...
    <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-sm-12 box-overlay" >
                        ...
                        <div class="box-address well detail_address">                        
                            ...
                            <div class="box-address-action">
                                ...
                                <button type="submit" class="btn btn-theme"><i class="fa fa-check"></i> {{ trans('cart.Select address') }}</button>
        ...
        <div class="col-lg-5 col-sm-12">
            ...
            <table class="table table-bordered table-cart" id="table-cart">
                <thead>
                    <tr class="text-center">
                        ...
                        <th style="width: 86px;">{{ trans('cart.SubTotal') }}</th>
                    </tr>
                </thead>
                <tbody>
                <?php
               foreach ($cal['data'] as $key => $value) {
                    ...
                    ?>
                    <tr>
                        <td class="img-cart" style="width: 63px; padding: 3px;vertical-align: middle;padding-right: 0;">
                            <a href="{{ url(UrlProduct($product->id, $product->slug_url)) }}">
                                ...
                                if(!empty($arrimg)){ ?>                                
                                    <img class="media-object img-thumbnail" src="<?= url(ImgProduct($arrimg[0]['id'], $arrimg[0]['new_name350']))?>" style="width: 56px">
                                <?php }else{ ?>
                                    <img class="media-object img-thumbnail" src="{{ URL::asset('image/nopicture.png') }}" style="width: 56px">
                                <?php }
                                ?>
                            </a>                               
                        </td>
            ...
            <div>
                <a href="{{ url(UrlCheckoutCart()) }}" class="btn btn-theme">{{ trans('cart.Back To Previous Page') }}</a>
            </div>
        </div>
